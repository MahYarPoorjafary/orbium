(function (orbium, undefined) {
    orbium.Menu = function () {
        ...
        this.setupTouchEvents = function () {
            ...
            orbium.Util.attachListener(select, "touchstart", function () {
                orbium.menu.select();
            });
            orbium.Util.attachListener(settings, "touchstart", function () {
                orbium.menu.settings();
            });
            orbium.Util.attachListener(about, "touchstart", function () {
                orbium.menu.about();
            });

            orbium.Util.attachListener(pack, "touchstart", function () {
                orbium.menu.changePack();
            });
            orbium.Util.attachListener(edit, "touchstart", function () {
                orbium.editor.edit();
            });
            orbium.Util.attachListener(prev, "touchstart", function () {
                orbium.menu.prev();
            });
            orbium.Util.attachListener(next, "touchstart", function () {
                orbium.menu.next();
            });
            orbium.Util.attachListener(play, "touchstart", function () {
                orbium.menu.start();
            });
            orbium.Util.attachListener(lvlb, "touchstart", function () {
                orbium.menu.lvlb();
            });

            orbium.Util.attachListener(support, "touchstart", function () {
                orbium.menu.support();
            });
            orbium.Util.attachListener(credits, "touchstart", function () {
                orbium.menu.credits();
            });
            orbium.Util.attachListener(abob, "touchstart", function () {
                orbium.menu.abob();
            });

            orbium.Util.attachListener(sound, "touchstart", function () {
                orbium.menu.toggleSound();
            });
            orbium.Util.attachListener(tutorial, "touchstart", function () {
                orbium.menu.toggleTutorial();
            });
            orbium.Util.attachListener(limits, "touchstart", function () {
                orbium.menu.toggleLimits();
            });
            orbium.Util.attachListener(settb, "touchstart", function () {
                orbium.menu.settb();
            });

            orbium.Util.attachListener(debug, "touchstart", function () {
                orbium.menu.debug();
            });
            orbium.Util.attachListener(reset, "touchstart", function () {
                orbium.menu.reset();
            });
            orbium.Util.attachListener(unlock, "touchstart", function () {
                orbium.menu.unlock();
            });
            orbium.Util.attachListener(editoron, "touchstart", function () {
                orbium.menu.editoron();
            });
            orbium.Util.attachListener(perfon, "touchstart", function () {
                orbium.menu.perfon();
            });
            orbium.Util.attachListener(connecton, "touchstart", function () {
                orbium.menu.connecton();
            });

            orbium.Util.attachListener(logo, "touchstart", function () {
                orbium.menu.logo();
            });

            orbium.Util.attachListener(credb, "touchstart", function () {
                orbium.menu.credb();
            });

            orbium.Util.attachListener(retry, "touchstart", function () {
                orbium.menu.retry();
            });
            orbium.Util.attachListener(failb, "touchstart", function () {
                orbium.menu.failb();
            });

            orbium.Util.attachListener(nextl, "touchstart", function () {
                orbium.menu.playNext();
            });
            orbium.Util.attachListener(compb, "touchstart", function () {
                orbium.menu.compb();
            });

            orbium.Util.attachListener(contact, "touchstart", function () {
                orbium.menu.contact();
            });
            orbium.Util.attachListener(gfx, "touchstart", function () {
                orbium.menu.gfx();
            });
        ...
        this.setupMouseEvents = function () {
            orbium.Util.attachListener(start, "mousedown", startFunc = function () {
                orbium.menu.start();
            });
            orbium.Util.attachListener(select, "mousedown", function () {
                orbium.menu.select();
            });
            orbium.Util.attachListener(settings, "mousedown", function () {
                orbium.menu.settings();
            });
            orbium.Util.attachListener(about, "mousedown", function () {
                orbium.menu.about();
            });

            orbium.Util.attachListener(pack, "mousedown", function () {
                orbium.menu.changePack();
            });
            orbium.Util.attachListener(edit, "mousedown", function () {
                orbium.editor.edit();
            });
            orbium.Util.attachListener(prev, "mousedown", function () {
                orbium.menu.prev();
            });
            orbium.Util.attachListener(next, "mousedown", function () {
                orbium.menu.next();
            });
            orbium.Util.attachListener(play, "mousedown", function () {
                orbium.menu.start();
            });
            orbium.Util.attachListener(lvlb, "mousedown", function () {
                orbium.menu.lvlb();
            });

            orbium.Util.attachListener(support, "mousedown", function () {
                orbium.menu.support();
            });
            orbium.Util.attachListener(credits, "mousedown", function () {
                orbium.menu.credits();
            });
            orbium.Util.attachListener(abob, "mousedown", function () {
                orbium.menu.abob();
            });

            orbium.Util.attachListener(sound, "mousedown", function () {
                orbium.menu.toggleSound();
            });
            orbium.Util.attachListener(tutorial, "mousedown", function () {
                orbium.menu.toggleTutorial();
            });
            orbium.Util.attachListener(limits, "mousedown", function () {
                orbium.menu.toggleLimits();
            });
            orbium.Util.attachListener(settb, "mousedown", function () {
                orbium.menu.settb();
            });

            orbium.Util.attachListener(debug, "mousedown", function () {
                orbium.menu.debug();
            });
            orbium.Util.attachListener(reset, "mousedown", function () {
                orbium.menu.reset();
            });
            orbium.Util.attachListener(unlock, "mousedown", function () {
                orbium.menu.unlock();
            });
            orbium.Util.attachListener(editoron, "mousedown", function () {
                orbium.menu.editoron();
            });
            orbium.Util.attachListener(perfon, "mousedown", function () {
                orbium.menu.perfon();
            });
            orbium.Util.attachListener(connecton, "mousedown", function () {
                orbium.menu.connecton();
            });

            orbium.Util.attachListener(logo, "mousedown", function () {
                orbium.menu.logo();
            });

            orbium.Util.attachListener(credb, "mousedown", function () {
                orbium.menu.credb();
            });

            orbium.Util.attachListener(retry, "mousedown", function () {
                orbium.menu.retry();
            });
            orbium.Util.attachListener(failb, "mousedown", function () {
                orbium.menu.failb();
            });

            orbium.Util.attachListener(nextl, "mousedown", function () {
                orbium.menu.playNext();
            });
            orbium.Util.attachListener(compb, "mousedown", function () {
                orbium.menu.compb();
            });

            orbium.Util.attachListener(contact, "mousedown", function () {
                orbium.menu.contact();
            });
            orbium.Util.attachListener(gfx, "mousedown", function () {
                orbium.menu.gfx();
            });
        ...
        this.showCompl = function () {
            if (orbium.machine.levnr === orbium.level.length - 1) {
                compl.style.top = "35%";
                comp.innerHTML = "آفرین کل مرحله ها رو تموم کردی";
                nextl.innerHTML = "شروع";
            } else {
                // Save level progress, set the level after just completed
                orbium.machine.saveLevel(orbium.machine.levnr + 1);

                compl.style.top = "35%";
                comp.innerHTML = "مرحله به اتمام رسید!";
                nextl.innerHTML = "بعدی";
            }
        ...
        this.updateStart = function () {
            if (orbium.has_touch_screen) {
                ...
                orbium.Util.attachListener(start, "touchstart", startFunc = function () {
                    orbium.menu.start();
                });
            } else {
        ...
        this.updateSound = function () {
            ...
            if (soundEnabled) {
                sound.innerHTML = "صدا : روشن";
                orbium.player.muted = false;
            } else {
                sound.innerHTML = "صدا : خاموش";
        ...
        this.updateTutorial = function () {
            if (orbium.tutorial.checkDisableTutorial()) {
                ...
                if (tutorialEnabled) {
                    tutorial.innerHTML = "راهنمایی: روشن";
                } else {
                    tutorial.innerHTML = "راهنمایی: خاموش";
                }
            }
        };
        ...
        this.updateLimits = function () {
            ...
            if (limitsEnabled) {
                limits.innerHTML = "محدودیت زمانی : روشن";
                orbium.Machine.timeLimits = true;
            } else {
                limits.innerHTML = "محدودیت زمانی : خاموش";
